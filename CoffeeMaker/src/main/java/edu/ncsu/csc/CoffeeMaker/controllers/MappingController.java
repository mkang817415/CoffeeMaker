...
public class MappingController {
    ...
    /**
     * On a Put request to /addingrdeint to inventory, the InventoryController will return
     * /src/main/resources/templates/index.html.
     *
     * @param model
     *            underlying UI model
    ...
    /**
     * On a GET request to /select a recipe from the list, the InventoryController will return
     * /src/main/resources/templates/editrecipe.html.
     *
     * @param model
     *            underlying UI model
     * @return contents of the page
     */
    @GetMapping ( { "/selectRecipe", "/selectRecipe.html" } )
    public String selectRecipe ( final Model model ) {
        return "editrecipe";
    }
